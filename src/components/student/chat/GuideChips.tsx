// 담당: 이유민
// "이런 이야기를 해도 좋아" 힌트 — 말하기 버튼 위 한 줄 글.
//
...
import { hintSentence } from "@/lib/chat/hints";
...
export default function GuideChips({
  ...
  if (!selectable) {
    ...
    // 말하기 버튼 바로 위에 한 줄 글로만 둔다. 흘리는 문장·말풍선은 요소가 많아 어수선했다(2026-09-20).
    return (
      <p className="guide-line" role="note">
        {hintSentence(hints)}
      </p>
    );
  }
