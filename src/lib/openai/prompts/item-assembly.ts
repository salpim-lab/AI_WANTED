...
position과 모든 제어점은 −2~2, rotation은 −2π~2π다.
size 각 축과 width/depth/height는 0.02~2다. 단, 곡면 판 depth는 0.01~0.2다.
일반 radius는 0.01~1, 캡슐은 0.01~0.5, 곡선 튜브는 0.01~0.3이다.
원뿔대 radiusTop은 0~1, radiusBottom은 0.01~1이다. 캡슐 length는 0~1이다.
고리 radius는 0.02~1, tubeRadius는 0.01~radius*0.8이다.
box roundness는 0~가장 짧은 size축/2이다.
용기의 두 외부 반지름은 0.02~1, 벽 두께는 0.01~두 반지름 중 작은 값*0.8이다.
바닥 두께는 0 또는 0.01~height*0.8이다. 용기를 다른 꽉 찬 도형으로 채우지 않는다.
윤곽 points는 3~32개, 좌표는 −2~2, depth는 0.02~1, bevel은 0~min(0.05,depth/2)다.
